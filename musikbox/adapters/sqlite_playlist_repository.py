...
class SqlitePlaylistRepository(PlaylistRepository):
    ...
    def __init__(self, db_path: Path) -> None:
        ...
        # check_same_thread=False: one long-lived connection is shared across the HTTP
        # server's worker threadpool (uvicorn runs the sync route handlers off-thread),
        # mirroring SqliteRepository. WAL keeps concurrent reads/writes safe for this
